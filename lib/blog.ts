...
export const blogPosts: BlogPost[] = [
  ...
  },
  {
    ...
    content: `
      <p>A great sauce has the power to turn a humble piece of chicken into something memorable, elevate a simple bowl of <a href="https://easyhomechef.com/recipes/dinner/spaghetti-carbonara" style="color: #2563eb; text-decoration: underline; font-weight: 500;">pasta</a> into a restaurant-worthy dish, or transform a plain salad into something you crave every single day. Yet despite their transformative power, sauces intimidate many home cooks. The truth is, once you understand a handful of core techniques, making great sauces becomes intuitive — and endlessly rewarding.</p>
      ...
      <p>This method is the foundation of beloved classics such as <a href="https://easyhomechef.com/recipes/dinner/chicken-marsala" style="color: #2563eb; text-decoration: underline; font-weight: 500;">Chicken Marsala</a>, where Marsala wine and earthy mushrooms form the base, and <a href="https://easyhomechef.com/recipes/dinner/chicken-piccata" style="color: #2563eb; text-decoration: underline; font-weight: 500;">Chicken Piccata</a>, with its bright, sharp lemon and caper sauce. Add chopped shallots, a sprig of fresh thyme, or a splash of double cream to adapt the flavour to whatever protein you are cooking. The technique works beautifully with fish too — our <a href="https://easyhomechef.com/recipes/quick-easy/pan-seared-salmon" style="color: #2563eb; text-decoration: underline; font-weight: 500;">Pan-Seared Salmon</a> with a quick lemon-butter pan sauce is a brilliant weeknight example.</p>
      ...
      <p>All three pair brilliantly with fish. Try a generous spoonful of herb sauce over our <a href="https://easyhomechef.com/recipes/dinner/grilled-salmon" style="color: #2563eb; text-decoration: underline; font-weight: 500;">Grilled Salmon</a> for an effortless, impressive dinner. For a rich, creamy pasta experience on the other end of the spectrum, our <a href="https://easyhomechef.com/recipes/dinner/chicken-alfredo" style="color: #2563eb; text-decoration: underline; font-weight: 500;">Chicken Alfredo</a> showcases how a well-made cream sauce can be every bit as satisfying.</p>
